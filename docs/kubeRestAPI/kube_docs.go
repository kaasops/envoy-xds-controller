// Package kubeRestAPI Code generated by swaggo/swag. DO NOT EDIT
package kubeRestAPI

import "github.com/swaggo/swag"

const docTemplatekube = `{
    ...
    "paths": {
        "/virtualservices": {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Virtual Service object",
                        "name": "virtualservice",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v1alpha1.VirtualService"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "v1alpha1.VirtualService": {
            ...
            "properties": {
                ...
                "spec": {
                    "$ref": "#/definitions/v1alpha1.VirtualServiceSpec"
                },
                "status": {
                    "$ref": "#/definitions/v1alpha1.VirtualServiceStatus"
                }
            }
        },
        "v1alpha1.VirtualServiceSpec": {
            "type": "object",
            "properties": {
                "accessLog": {
                ...
                "tlsConfig": {
                    "$ref": "#/definitions/v1alpha1.TlsConfig"
                },
                "upgradeConfigs": {
...
// SwaggerInfokube holds exported Swagger Info so clients can modify it
var SwaggerInfokube = &swag.Spec{
	Version:          "",
	Host:             "",
	BasePath:         "",
	Schemes:          []string{},
	Title:            "",
	Description:      "",
	InfoInstanceName: "kube",
	SwaggerTemplate:  docTemplatekube,
	LeftDelim:        "{{",
	RightDelim:       "}}",
}

func init() {
	swag.Register(SwaggerInfokube.InstanceName(), SwaggerInfokube)
}
