...
type ResourceRefs struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Refs          []*ResourceRef         `protobuf:"bytes,2,rep,name=refs,proto3" json:"refs,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ResourceRefs) Reset() {
	*x = ResourceRefs{}
...
func (x *ResourceRefs) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ResourceRefs) ProtoMessage() {}

func (x *ResourceRefs) ProtoReflect() protoreflect.Message {
	mi := &file_common_v1_common_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ResourceRefs.ProtoReflect.Descriptor instead.
func (*ResourceRefs) Descriptor() ([]byte, []int) {
	return file_common_v1_common_proto_rawDescGZIP(), []int{3}
}

func (x *ResourceRefs) GetRefs() []*ResourceRef {
	if x != nil {
		return x.Refs
	}
	return nil
...
type TLSConfig struct {
	...
	AutoDiscovery *bool                  `protobuf:"varint,2,opt,name=auto_discovery,json=autoDiscovery,proto3,oneof" json:"auto_discovery,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TLSConfig) GetSecretRef() *ResourceRef {
	if x != nil {
		return x.SecretRef
	}
	return nil
...
var file_common_v1_common_proto_rawDesc = string([]byte{
	...
	,
...
var file_common_v1_common_proto_goTypes = []any{
	...
	(*VirtualHost)(nil),  // 1: common.v1.VirtualHost
	(*UIDS)(nil),         // 2: common.v1.UIDS
	(*ResourceRefs)(nil), // 3: common.v1.ResourceRefs
	(*TLSConfig)(nil),    // 4: common.v1.TLSConfig
}
var file_common_v1_common_proto_depIdxs = []int32{
	0, // 0: common.v1.ResourceRefs.refs:type_name -> common.v1.ResourceRef
	0, // 1: common.v1.TLSConfig.secret_ref:type_name -> common.v1.ResourceRef
