...
func CompareImplementationsTest(t *testing.T, store store.Store, vs *v1alpha1.VirtualService) {
	...
	originalBuilder := resbuilder.NewResourceBuilder(store)

	newBuilder := resbuilder.NewResourceBuilder(store)
...
func compareResources(original, new *resbuilder.Resources) []string {
...
func TestBasicHTTPRouting(t *testing.T) {
	...
	// TODO: Implement CompareImplementationsTest function
